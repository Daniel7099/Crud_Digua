			...
			<form name="form" action="guardar.php" method="post">
                ...
                <div class="row">
 				    ...
 				    <div class="col-sm-4">
                        ...
                        <input type="text" id="" onkeyup="countChars_nombre(this);" name="nombre" maxlength="40" placeholder="Nombre" autofocus="true" class="form-control txt_detalle" required pattern="[A-Za-z ]+" title="Los nombres tienen que ser hasta 40 digitos y solo es posible contener letras." />
                ...
                <div class="row">
 				    <div class="col-sm-4">
                        ...
                        <input type="text" onkeyup="countChars_apellido(this);" name="apellido" maxlength="40" placeholder="Apellido" autofocus="true" class="form-control" required pattern="[A-Za-z ]+" title="Los apellidos tienen que ser hasta 40 digitos y solo es posible contener letras." />
                    </div>
                    <div class="col-lg-3">
                    <div class="form-group">
                ...
                <div class="row">
 				    <div class="col-sm-4">
                        ...
                        <input type="email" onkeyup="countChars_correo(this);" name="correo" maxlength="50" placeholder="E-Mail" class="form-control" 
                ...
                <div class="row">
                    ...
                    <label for="telefono">Teléfono:</label>
                        <input type="tel" id ="" onkeyup="countChars_telefono(this);" name="telefono" maxlength="15" placeholder="Teléfono" class="form-control" 
                ...
                <div class="row">
 				    <div class="col-sm-4">
                        ...
                        <input type="tel" id ="" onkeyup="countChars_telefono2(this);" name="telefono2" maxlength="15"  placeholder="Telefono2" autofocus="true" class="form-control" 
                ...
                <div class="row">
 				    <div class="col-sm-4">
                        ...
                        <input type="tel" onkeyup="countChars_Celular(this);" name="celular" maxlength="15" placeholder="Celular" autofocus="true" class="form-control" 
                ...
                <div class="row">
 				    <div class="col-sm-4">
                        ...
                        <input type="text" onkeyup="countChars_direccion(this);" name="direccion" maxlength="50" placeholder="Dirección" autofocus="true" class="form-control" title="La direccion tiene que ser hasta 50 digitos.Puede contener letras, numeros, signos, guiones. puntos." />
                    </div>
                    <div class="col-lg-3">
                    <div class="form-group">
                ...
                <div class="row">
 				    <div class="col-sm-4">
                        ...
                        <input type="text" onkeyup="countChars_empresarubro(this);" name="empresa" maxlength="40" placeholder="Empresa" autofocus="true" class="form-control" 
